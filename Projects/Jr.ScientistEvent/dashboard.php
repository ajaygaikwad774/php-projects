...
<head>
  ...
  <meta name="description" content=" Pro Dashboard ">
  <meta name="author" content=" Gunwanta Dhon ">
  <title>Jr. Scientist Dashboard </title>
      ...
      <div class="navbar-inner">
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="studDetails03.php" >
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Total Collection</h5>
                      <span class="h2 font-weight-bold mb-0">3,50,897</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">New entries</h5>
                      <span class="h2 font-weight-bold mb-0">600</span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">3,00,000</span>
                    </div>
                    <div class="col-auto">
