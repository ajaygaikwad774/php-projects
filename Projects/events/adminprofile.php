...
<body>
    ...
    <div class="page-wrapper chiller-theme sidebar-bg bg1 toggled">
        ...
        <main class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <center> <h5 style="font-weight: bold;"> Applied for Membership </h5> </center>
                        <br>
 ...
 ?>
   <tr >
    ...
    <td> <button class="btn-danger btn"> <a href="delete.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button> / <button class="btn-primary btn"> <a href="addmembers.php?id=<?php echo $res['id']; ?>" class="text-white"> Add Members </a> </button> </td>
