            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    ...
                    <div class="card rounded-0 border-success">
                        ...
                        <div class="card-body">
                            <form class="form" role="form" action="validate.php" id="formLogin"   method="POST" action="process.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control form-control-lg rounded-0" id="password" name="password" required autocomplete="off">
