      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
       ...
       <div class="main-panel">
          <div class="content-wrapper">
            <br>
            <h5> Addmission Details </h5>
            <hr style="background-color: red;">
            <div class="card">
              <div class="card-header" style="background-color: #e6e6e6;"> Manage Addmission 
                <span style="float: right;"> <a href="addform.php" class="btn btn-primary"><i class="mdi mdi-plus" ></i> Add Student</a> </span>
               </div>
              <div class="card-body">
                <h4 class="card-title">Addmission Details </h4>
                <div class="row">
                  <div class="col-12">
                    <table id="order-listing" class="table table-bordered table-stripped table-hover table-responsive">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><img src="images/faces-clipart/pic-4.png" alt="image"/> &nbsp; 
                             <?php echo $row['first_name'].' '.$row['last_name']; ?> </td>  
                          <td><?php echo date('d-m-Y',strtotime($row['doa'])) ?></td>
                          ...
                          <td>
                            <button class="btn btn-outline-warning"> <a href="php_action/editadddetails.php?editId=<?php echo $row['student_id'];?>"> Edit </a> </button> &nbsp;
                            <button class="btn btn-outline-danger"> <a href="php_action/deleteadddetails.php?deleteId=<?php echo 
                             $row['student_id'];?>&picture=<?php echo $row['photoname']; ?> " > Delete  </a> </button>
                          </td>
                        </tr>
                        <?php
                          }
